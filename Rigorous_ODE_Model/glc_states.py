...
def glc_rto_f(y,u):
    """
    This function defines the RHS of the gas-lift oil well dynamics.

    y is a torch tensor representing state variables [m_G_an, m_G_tb, m_L_tb]
    u is a torch tensor representing the control inputs [u1, u2]

    It has NO SAFEGUARDS FOR TRAINING
    """
